...
public class GlucoseData implements Comparable<GlucoseData>, Serializable {
    ...
    public void setTrendData(boolean trendData) {
        isTrendData = trendData;
    }

    public void setAgeInSensorMinutes(int ageInSensorMinutes) {
    ...
    public String toString() {
        return "GlucoseData [id=" + id + ", sensor=" + sensor.toString() + ", ageInSensorMinutes=" + ageInSensorMinutes + ", timezoneOffsetInMinutes="
                + timezoneOffsetInMinutes + ", glucoseLevelRaw=" + glucoseLevelRaw + ", isTrendData=" + isTrendData + "date=" + date + "]";
    }
