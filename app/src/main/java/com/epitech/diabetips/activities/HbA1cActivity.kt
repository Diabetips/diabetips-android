...
class HbA1cActivity : ADiabetipsActivity(R.layout.activity_hba1c) {
    ...
    private fun openHbA1cPopup(hba1c: HbA1cObject = HbA1cObject()) {
        DialogHandler.createDialog(this, layoutInflater, R.layout.dialog_hba1c) { view, dialog ->
            ...
            view.hba1cTimeDate.setOnClickListener {
                DialogHandler.datePickerDialog(this, supportFragmentManager, hba1c.time, view.hba1cTimeDate) { time ->
                    hba1c.time = time
                }
            }
            view.hba1cTimeHour.setOnClickListener {
                DialogHandler.timePickerDialog(this, supportFragmentManager, hba1c.time, view.hba1cTimeHour) { time ->
                    hba1c.time = time
                }
            }
            ...
            view.hba1cDeleteButton.setOnClickListener {
                DialogHandler.dialogConfirm(this, layoutInflater, R.string.hba1c_delete) {
